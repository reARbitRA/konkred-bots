...
const PYTHON_OWNED = new Set([
  ...
  'BOT_MODE', 'WEB_HOST', 'WEBHOOK_HOST', 'WEBHOOK_SECRET',
  'PAYMENTS_ENABLED', 'FREE_REQUESTS', 'STARS_PRICE', 'PAID_ACCESS_DAYS',
  'PAYMENT_SECRET', 'USDT_WALLET_ADDRESS', 'USDT_NETWORK', 'USDT_PRICE',
  'PAYMENT_ADMIN_IDS', 'PAYMENT_SUPPORT',
