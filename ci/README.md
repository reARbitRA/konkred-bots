...
| **bots** | `compileall`, `flake8`, router/command wiring against `BOT_SPECS`, 300 randomised message-splitter invariant cases, graceful degradation across 25 gateway-failure scenarios, and Redis history + FSM namespace isolation on fakeredis |
...
[PASS] bots/Bots stay usable when the gateway fails
